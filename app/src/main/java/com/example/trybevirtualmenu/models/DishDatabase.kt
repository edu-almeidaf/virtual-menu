    ...
    private val dishes = listOf(
        ...
        Dish(
            ...
            "Uma opção saudável e saborosa: peitos de frango suculentos grelhados à " +
                "perfeição, acompanhados de legumes frescos, preparados para manter a " +
        ...
        Dish(
            ...
            R.drawable.prato_04,
            "Uma refeição de dar água na boca! Picanha de primeira qualidade, grelhada à perfeição e " +
                "servida com macaxeira frita crocante. Um prato que celebra o melhor da culinária brasileira.",
            "R$90.00"
        ),
        Dish(
            fifthId,
            ...
            R.drawable.prato_05,
            "Para os amantes de batatas, esta é a escolha ideal. Nossas batatas fritas são cortadas e " +
                "preparadas na hora para garantir a crocância perfeita. Acompanhadas de uma variedade de molhos " +
                "incríveis que vão tornar cada mordida ainda mais especial. Acompanhamento perfeito para " +
                "qualquer refeição.",
            "R$20.00"
        ),
        Dish(
            ...
            "Um gole de pura refrescância e vitalidade. Nosso suco de laranja é feito com as laranjas " +
                "mais suculentas e frescas, espremidas na hora para garantir o sabor cítrico e natural que todos " +
                "adoram. Perfeito para acompanhar suas refeições ou para matar a sede a qualquer hora do dia. " +
